...
const articles = Array(10).fill(0).map((_, index) => ({ ...article, id: index.toString() }));
...
export const IsLoadingTileView: Story = {
  args: {
    isLoading: true,
    articles,
